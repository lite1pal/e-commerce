...
export default function Item(props: {
  ...
  return (
    ...
    >
      ...
      {/* <div className="absolute left-1 top-1 w-fit rounded bg-slate-200 p-1 text-sm font-bold text-purple-800 transition group-hover:-translate-y-2">
        ${item.price}.00 USD
      </div> */}
      <div className="absolute bottom-0 flex w-full items-center justify-between gap-3 border border-t-0 border-gray-100 border-opacity-20 bg-slate-900 p-3 group-hover:border-opacity-0">
        ...
        {addItemToCartLoading || deleteCartItemLoading ? (
          ...
          <div
            ...
            } flex cursor-pointer gap-1 rounded border-gray-100 border-opacity-20 p-3  hover:bg-slate-700 `}
          >
